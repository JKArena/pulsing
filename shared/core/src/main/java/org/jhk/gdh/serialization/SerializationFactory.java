 ...
 * under the License.
 */
package org.jhk.gdh.serialization;
...
import org.jhk.gdh.serialization.pojo.IAddress;
import org.jhk.gdh.serialization.pojo.IDeed;
import org.jhk.gdh.serialization.pojo.IFoundation;
import org.jhk.gdh.serialization.pojo.IUser;
...
public final class SerializationFactory {
    ...
    static {
        AVRO_MAPPER.put(IAddress.class, org.jhk.gdh.serialization.avro.Address.getClassSchema());
        AVRO_MAPPER.put(IDeed.class, org.jhk.gdh.serialization.avro.Address.getClassSchema());
        AVRO_MAPPER.put(IFoundation.class, org.jhk.gdh.serialization.avro.Foundation.getClassSchema());
        AVRO_MAPPER.put(IUser.class, org.jhk.gdh.serialization.avro.User.getClassSchema());
        
        THRIFT_MAPPER.put(IAddress.class, org.jhk.gdh.serialization.thrift.Address.class);
        THRIFT_MAPPER.put(IDeed.class, org.jhk.gdh.serialization.thrift.Deed.class);
        THRIFT_MAPPER.put(IFoundation.class, org.jhk.gdh.serialization.thrift.Foundation.class);
        THRIFT_MAPPER.put(IUser.class, org.jhk.gdh.serialization.thrift.User.class);
    }
