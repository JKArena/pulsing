 ...
 * @author Ji Kim
 */
public final class AvroRecordFormatBolt implements RecordFormat {

    private static final long serialVersionUID = 4428995373474976585L;
    private static final Logger _LOGGER = LoggerFactory.getLogger(AvroRecordFormatBolt.class);
