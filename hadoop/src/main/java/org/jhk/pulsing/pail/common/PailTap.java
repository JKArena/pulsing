...
public final class PailTap extends Hfs {
    ...
    public static class PailTapOptions implements Serializable {
        ...
        public PailTapOptions(PailSpec spec, String fieldName,
                List<String>[] attrs, PailPathLister lister) {
            this.spec = spec;
    ...
    public class PailScheme extends Scheme<JobConf, RecordReader, OutputCollector, Object[], Object[]> {
        ...
        public PailStructure getStructure() {
            if (_structure == null) {
                if (getSpec() == null) {
                    _structure = PailFormatFactory.getDefaultCopy()
                            .getStructure();
                } else {
        ...
        public void sink(FlowProcess<JobConf> process,
            ...
            if (getStructure() instanceof DefaultPailStructure) {
                ...
                key = Utils.join(getStructure().getTarget(obj), "/")
                        + getCategory(obj);
            }
            if (bw == null) {
    ...
    public long getModifiedTime(JobConf conf) throws IOException {
        // TODO: We should either set sinkMode.REPLACE or return something real
        // here when used as a source.
        return 0;
    }
    ...
    public void sourceConfInit(FlowProcess<JobConf> process, JobConf conf) {
        try {
            ...
            makeLocal(conf, getQualifiedPath(conf),
                    "forcing job to local mode, via source: ");
    ...
    private void makeLocal(JobConf conf, Path qualifiedPath,
            String infoMessage) {
    ...
    public boolean commitResource(JobConf conf) throws IOException {
        Pail p = Pail.create(_pailRoot, ((PailScheme) getScheme()).getSpec(),
                false);
