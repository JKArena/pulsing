...
const FETCH_RESPONSE_HANDLER = Object.freeze(Object.create(null, {
  ...
  [BASIC]: (response, resolve, reject, basic_type) => {
    response[basic_type]()
...
export const fetchHelper = Object.freeze(Object.create(null,
{
  'GET_JSON' : (gUrl, hOptions=Object.create(null), params=Object.create(null), logError=true) => {
